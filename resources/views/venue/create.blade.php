...
<div class="my-10 w-11/12 md:w-9/12 lg:w-8/12 mx-auto border-2 bg-slate-200 rounded-lg">
    ...
    <form action="{{ route('venue.store') }}" method="POST" enctype="multipart/form-data" class="px-6 py-4">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            <label for="location" class="text-gray-800">Location</label>
        ...
        <div class="mb-4">
            <label for="capacity" class="text-gray-800">Capacity</label>
