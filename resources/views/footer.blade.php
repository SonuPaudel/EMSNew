...
<footer class="bg-neutral-100 text-center text-neutral-600 lg:text-left">
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid gap-24 sm:grid-cols-3 md:grid-cols-12 lg:grid-cols-12">
      <!-- Tailwind Elements section -->
      <div class="lg:col-start-4 lg:col-span-3 sm:col-span-1 sm:col-start-0">
  ...
  <div class="bg-neutral-200 p-6 text-center">
    ...
    <a class="font-semibold text-neutral-600" href="#">EMS</a>
  </div>
</footer>