            ...
            <div class="p-8 flex-1">
                <div class="w-80 bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">
                    ...
                    <div class="px-10 pt-4 pb-8 bg-white rounded-tr-4xl">
                        <h1 class="text-2xl font-semibold text-gray-900">Welcome to!</h1>
                        <form class="mt-12" action="{{route('login')}}" method="POST">
                            @csrf
                            <div class="relative">
                                <input id="email" name="email" type="text" class="px-0 peer h-10 w-full border-0 border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:ring-0" placeholder="john@doe.com" />
