...
<div class="flex">
    <div class="object-cover h-full relative">
        <img class="w-screen" src="{{asset('images/home.jpg')}}" alt="">
        ...
        <div class="w-full bg-white mt-24 h-full float-left">
            ...
            <div class="grid grid-cols-3 gap-20 p-10 ml-auto mr-auto w-9/12 mt-5">
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="px-6 pt-4 pb-2">
                        <a href="{{route('offerdetails',$offer->id)}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition-colors duration-300 text-center">
                            View Details
                        </a>
                    </div>
                </div>
