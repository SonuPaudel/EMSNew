...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-5 sm:w-9/12 mx-auto mb-10">
    <img class="w-screen h-96" src="{{asset('images/contact-bg.png')}}" alt="">
    <div class="grid grid-cols-2 gap-10 p-6 w-11/12 h-5/6">
